  ...
  return (
    <>
      {isLoading ? (
        ...
        <div data-aos="fade-in" className="py-4">
          <div
            data-aos="zoom-in"
            className="container m-auto py-8 px-5 border-b-2 border-gray-50 my-16"
          >
          ...
          <div className="md:w-1/2 m-auto p-6 mt-0 flex flex-col md:flex-row justify-between items-center">
            <div className="space-y-4 w-[350px] m-auto">
              ...
              >
                ...
                >
                  <h1 className="font-bold ">
                    Article On The Benefits of Responsive Design to Companies
                    Growth
                  </h1>
                </Link>
              </div>
